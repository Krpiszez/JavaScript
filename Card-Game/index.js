...
const cardObjectDefinitions = [
    {id:1, imagePath:'/Card-Game/images/card-KingHearts.png'},
    {id:2, imagePath:'/Card-Game/images/card-JackClubs.png'},
    {id:3, imagePath:'/Card-Game/images/card-QueenDiamonds.png'},
    {id:4, imagePath:'/Card-Game/images/card-AceSpades.png'}
]
const aceId = 4

const cardBackImgPath = '/Card-Game/images/card-back-blue.png'
